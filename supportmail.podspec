#
#  Be sure to run `pod spec lint supportmail.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "mrketchup" => "matthewjones1988@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'mrketchup', 'other author'
  ...
  s.resource  = "SupportMail.strings"
